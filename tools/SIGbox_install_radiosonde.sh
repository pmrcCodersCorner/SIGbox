...
echo "  #"
echo " "
cd $SIGDEB_SOURCE/RS/rs41
cp $SIGDEB_SOURCE/RS/ecc/bch_ecc.c .
cp $SIGDEB_SOURCE/RS/demod/mod/bch_ecc_mod.c .
cp $SIGDEB_SOURCE/RS/demod/mod/bch_ecc_mod.h .
...
echo "  #"
echo " "
cd $SIGDEB_SOURCE/RS/m10
gcc m10ptu.c -lm -o m10ptu
gcc m10gtop.c -lm -o m10gtop
sudo chown root:root m10ptu m10gtop
sudo cp m10ptu m10gtop $SIGDEB_EXE
cd $SIGDEB_SOURCE/RS/m10/pilotsonde
gcc m12.c -lm -o m12
...
echo "  #"
echo " "
cd $SIGDEB_SOURCE/RS/demod
cp $SIGDEB_SOURCE/RS/ecc/bch_ecc.c .
cp $SIGDEB_SOURCE/RS/demod/mod/bch_ecc_mod.c .
cp $SIGDEB_SOURCE/RS/demod/mod/bch_ecc_mod.h .
cp $SIGDEB_SOURCE/RS/rs92/nav_gps_vel.c .
