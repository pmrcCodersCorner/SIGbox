...
###
### Given a Ubuntu 20.04 Desktop installed this script installs
### drivers and applications for RF use cases that include hacking and 
...
SIG_UPDATE_TXT1=$SIGDEB_HOME/updates/SIGdeb-update-1.txt
SIG_UPDATE_TXT2=$SIGDEB_HOME/updates/SIGdeb-update-2.txt
SIG_UPDATE_TXT3=$SIGDEB_HOME/updates/SIGdeb-update-3.txt
...
select_startscreen(){
    TERM=ansi whiptail --title "SIGdeb Update" --textbox $SIG_UPDATE_TXT1 24 120 16
}
...
select_hamradio
select_utilities
TERM=ansi whiptail --title "SIGdeb Update" --msgbox "Ready to Install" 12 120
